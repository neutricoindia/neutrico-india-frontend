...
export const metadata = {
  ...
  description: `Elevate your well-being with NEUTRICO INDIA. Quality, Safety, and Wellness. Choose NEUTRICO INDIA. Your partner in health. Science-backed nutrition for a healthier you.`,
  keywords:
